...
def get_daily_stats() -> Dict:
    ...
    stats = {
        ...
        "wins": wins,
        "losses": losses,
        "best_trade": f"{best_trade['symbol']} +${best_trade['pnl']:.2f}" if best_trade and best_trade.get('pnl', 0) >= 0 else (f"{best_trade['symbol']} ${best_trade['pnl']:.2f}" if best_trade else "None"),
        "worst_trade": f"{worst_trade['symbol']} ${worst_trade['pnl']:.2f}" if worst_trade else "None",

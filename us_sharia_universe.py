...
# Stocks to exclude (known non-Sharia compliant OR delisted/invalid)
EXCLUDED_TICKERS = {
    ...
    "PLBY", "RICK",
    # Delisted / Invalid symbols (verified 2026-06-06: no yfinance data)
    "ANSS",  # Ansys — acquired/delisted
    "CHK",   # Chesapeake Energy — emerged from bankruptcy, ticker changed
    "CTRA",  # Coterra Energy — data stale since May 2026
    "DFS",   # Discover Financial — ticker changed/delisted from Yahoo
    "HCP",   # Healthcare Realty — merged/acquired
    "HOLX",  # Hologic — data issue
    "MAXR",  # Maxar Technologies — went private
    "MRO",   # Marathon Oil — possibly acquired (ConocoPhillips merger)
    "PEAK",  # Healthpeak Properties — merged
    "PXD",   # Pioneer Natural Resources — acquired by ExxonMobil
    "SQ",    # Block Inc — data issue (should still be valid but yfinance broken)
    "SWN",   # Southwestern Energy — merged/ticker changed
}
